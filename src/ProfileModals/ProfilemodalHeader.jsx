...
export default function ProfilemodalHeader({ theme, activeTab2, setActiveTab2, color2, data }) {
    const followersCount = data?.getCurrentLoggedInUser?.followers ||0;
    const followingCount = data?.getCurrentLoggedInUser?.following || 0;
